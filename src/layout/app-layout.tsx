...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'financial-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Budgets', path: '/budgets', entity: 'budget', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    {
    ...
    {
      name: 'Financial Programs',
      path: '/financial-programs',
