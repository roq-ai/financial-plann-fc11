...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_created.create': { roles: ['owner', 'financial-manager'], key: 'order_id', tenantPath: [], userPath: [] },
  'payment_received.create': { roles: ['owner', 'financial-manager'], key: 'payment_id', tenantPath: [], userPath: [] },
  'item_out_of_stock.update': { roles: ['owner'], key: 'item_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['owner', 'financial-manager'];
