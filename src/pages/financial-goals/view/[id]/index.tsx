...
import { getFinancialGoalById } from 'apiSdk/financial-goals';
import { FinancialGoalInterface } from 'interfaces/financial-goal';

function FinancialGoalViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('financial_goal', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/financial-goals/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Target Amount" text={data?.target_amount} />
