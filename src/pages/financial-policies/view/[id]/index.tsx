...
import { getFinancialPolicyById } from 'apiSdk/financial-policies';
import { FinancialPolicyInterface } from 'interfaces/financial-policy';

function FinancialPolicyViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Financial Policy Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('financial_policy', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/financial-policies/edit/${id}`} passHref legacyBehavior>
                    <Button
