...
import { createFinancialPolicy } from 'apiSdk/financial-policies';
...
function FinancialPolicyCreatePage() {
  ...
  const handleSubmit = async (values: FinancialPolicyInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createFinancialPolicy(values);
      resetForm();
